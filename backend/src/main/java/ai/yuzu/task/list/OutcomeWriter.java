...
/** v0.0.10 🍊 Writes the one-sentence outcome ("how it went") stored on a task list when it is archived. */
final class OutcomeWriter {
    ...
    /** v0.0.10 🍊 "Completed with changes: 3 of 4 items done, 1 struck. Approved by Alice (human)." and similar. */
