...
/** v0.0.20 🍊 API shape of a task list (contract {@code TaskList}) plus Java-only publisherKind, previousGoals. */
public record TaskList(String id, String agentId, String goal, TaskListStatus status, String publisherId,
    ...
    /** v0.0.20 🍊 Defensive, immutable copies of the item and goal lists. */
    public TaskList {
        items = items == null ? List.of() : List.copyOf(items);
        previousGoals = previousGoals == null ? List.of() : List.copyOf(previousGoals);
    }

    /** v0.0.20 🍊 The item shown as number {@code ord} in prompts ("[x] 2. ..."), if any. */
