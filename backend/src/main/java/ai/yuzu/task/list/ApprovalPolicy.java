...
/** v0.0.20 🍊 Who may approve (and so archive) a finished task list: its publisher or any human, never the owner. */
final class ApprovalPolicy {
    ...
    /** v0.0.20 🍊 Humans always pass; an agent must be the list's publisher, not its owner, and hold TASK_APPROVE. */
