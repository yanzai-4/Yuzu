...
/** v0.0.20 🍊 An agent's current task list (null when none) and latest archived lists (contract TaskListView). */
public record TaskListView(String agentId, @JsonInclude(JsonInclude.Include.ALWAYS) TaskList current,
    ...
    /** v0.0.20 🍊 Defensive, immutable copy of the archived lists. */
    public TaskListView {
