...
/** v0.0.10 🍊 Code-level rules for who may create, assign, work on, approve or cancel a ticket. */
final class TicketPolicy {
    ...
    /** v0.0.10 🍊 Managing tickets (create, assign, cancel) needs a human or an agent holding TASK_ASSIGN. */
    void requireCanManage(Actor actor, String action) {
        actors.require(actor, Permission.TASK_ASSIGN, action);
    }

    /** v0.0.10 🍊 Working on a ticket needs its assignee, a human, or a TASK_ASSIGN agent. */
    ...
    /** v0.0.10 🍊 Checks the actor may move the ticket to the target status. */
    ...
    /** v0.0.10 🍊 Approval needs a human, or whoever assigned the ticket holding TASK_APPROVE (never the assignee). */
