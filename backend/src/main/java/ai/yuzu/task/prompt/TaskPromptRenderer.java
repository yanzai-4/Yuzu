...
/** v0.0.20 🍊 Byte-stable English renderings of task lists for LLM prompts (absolute times only). */
public final class TaskPromptRenderer {
    ...
    /** v0.0.20 🍊 The agent's current list ("Goal: ...", "[x] 1. ..."), or a fixed sentence when there is none. */
    ...
    /** v0.0.20 🍊 One list: goal, earlier goals, publisher, status, ticket, start time, progress, then every item. */
    ...
    /** v0.0.20 🍊 The latest archived lists in the given order (most recent first) with their outcome and items. */
    ...
    /** v0.0.20 🍊 "[ ] 4. text", "[>] 3. text (in progress)", "[x] 1. text", "[~] 2. text (struck: reason)". */
    ...
    /** v0.0.20 🍊 Checkbox marker of an item state. */
    ...
    /** v0.0.20 🍊 "Alice (human)" or "Yuzu (agent)"; the kind falls back to the id shape. */
    ...
    /** v0.0.20 🍊 Status sentence: in progress, awaiting approval (and by whom), or archived (and when). */
    ...
    /** v0.0.20 🍊 "2 of 4 finished (1 done, 1 struck, 1 in progress, 1 to do)" or "no items yet". */
