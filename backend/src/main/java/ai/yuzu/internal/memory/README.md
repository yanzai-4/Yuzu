...
> v0.0.13 🍊 The agent's memories. Working memory now; habit and deep memory follow in later steps.
...
- `WorkingMemoryCompactor` — digest function (the AI implementation arrives with the module base class).
