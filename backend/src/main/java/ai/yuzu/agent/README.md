...
> v0.0.34 🍊 Agents as employees: identity, job, persona, permissions and limits.
...
- `AgentService` — hire (max 8 per workgroup, **exactly one Project Manager**, per-room lock), edit
  (optimistic locking), pause/resume,
