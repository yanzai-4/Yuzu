...
/** v0.0.10 🍊 The JSON form of task operations that the planning module parses from model output. */
class TaskOpTest {

    private final ObjectMapper mapper = new ObjectMapper();

    /** v0.0.10 🍊 Every operation kind reads from its "op" discriminator. */
    @Test
    ...
    /** v0.0.10 🍊 Writing an operation keeps the discriminator and only the record fields. */
    @Test
