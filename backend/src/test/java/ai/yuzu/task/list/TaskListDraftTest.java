...
/** v0.0.20 🍊 Unit tests of the task-operation rules (no database). */
class TaskListDraftTest {
    ...
    /** v0.0.20 🍊 CHECK, STRIKE and NOTE change states and notes but never remove an item. */
    @Test
    ...
    /** v0.0.20 🍊 Re-checking, re-starting and re-striking are idempotent (nothing to write). */
    @Test
    ...
    /** v0.0.20 🍊 A DONE item may still be struck through when a reason is given. */
    @Test
    ...
    /** v0.0.20 🍊 Every invalid operation is reported in one pass; the first problem picks the exception type. */
    @Test
    ...
    /** v0.0.20 🍊 Later operations see the effect of earlier ones in the same batch. */
    @Test
    ...
    /** v0.0.20 🍊 ADD appends with the next ord, refuses duplicates of open items, and reopens an awaiting list. */
    @Test
    ...
    /** v0.0.20 🍊 EDIT_GOAL keeps the previous goal and its reason in the history. */
    @Test
    ...
    /** v0.0.20 🍊 Notes are appended with "; " and a note already present is not repeated. */
    @Test
    ...
    /** v0.0.20 🍊 Initial items of a new list follow the ADD rules and are reported as "Item N". */
    @Test
    ...
    /** v0.0.20 🍊 Archived lists can never be drafted. */
    @Test
    ...
    /** v0.0.20 🍊 A draft of the list in the given status with the given items (version 4, created at T0). */
    ...
    /** v0.0.20 🍊 A persisted item "Item N" in the given state. */
