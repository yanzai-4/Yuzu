...
/** v0.0.10 🍊 Exact, byte-stable prompt renderings of current and archived task lists. */
class TaskPromptRendererTest {

    private static final String STARTED = "Sat Sep 19, 11:32:05 AM";

    /** v0.0.10 🍊 The current list renders exactly in the documented format. */
    @Test
    ...
    /** v0.0.10 🍊 Same data gives the same bytes, whatever order the items arrive in. */
    @Test
    ...
    /** v0.0.10 🍊 No current list and no history render as fixed sentences. */
    @Test
    ...
    /** v0.0.10 🍊 Archived lists render with times, outcome and items, in the given (most recent first) order. */
    @Test
    ...
    /** v0.0.10 🍊 Line breaks inside texts are flattened, so stored text can never forge extra item lines. */
    @Test
    ...
    /** v0.0.10 🍊 The four items used by the current-list tests. */
    ...
    /** v0.0.10 🍊 An ACTIVE list published by Alice, linked to a ticket, whose goal was edited once. */
    ...
    /** v0.0.10 🍊 An archived list with an outcome. */
