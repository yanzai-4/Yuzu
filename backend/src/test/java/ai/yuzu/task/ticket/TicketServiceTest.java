...
/** v0.0.10 🍊 Tickets against MySQL: who may create and assign, the lifecycle, list links and ticket.upsert events. */
@IntegrationTest
...
class TicketServiceTest {
    ...
    /** v0.0.10 🍊 Humans and TASK_ASSIGN agents create tickets; ids carry the owner (system for humans). */
    @Test
    ...
    /** v0.0.10 🍊 Agents without TASK_ASSIGN can neither create, assign nor cancel tickets. */
    @Test
    ...
    /** v0.0.10 🍊 The lifecycle is enforced, with per-status permissions. */
    @Test
    ...
    /** v0.0.10 🍊 A ticket follows its task list: IN_PROGRESS on start, DONE when finished, APPROVED on approval. */
    @Test
    ...
    /** v0.0.10 🍊 A task list can only start from a ticket assigned to its owner and not yet linked. */
    @Test
    ...
    /** v0.0.10 🍊 linkList attaches an existing list to a ticket and updates both sides. */
    @Test
    ...
    /** v0.0.10 🍊 Every ticket change publishes ticket.upsert with the contract shape. */
    @Test
