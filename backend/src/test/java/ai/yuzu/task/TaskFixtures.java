...
/** v0.0.10 🍊 Creates isolated rooms, humans and agents for task-system integration tests. */
public final class TaskFixtures {
    ...
    /** v0.0.10 🍊 Wraps the beans the fixtures need. */
    ...
    /** v0.0.10 🍊 A fresh room {@code room-fxxx} (the f-range stays clear of rooms other tests insert by hand). */
    ...
    /** v0.0.10 🍊 Hires an agent with the role's default permissions. */
    ...
    /** v0.0.10 🍊 Hires an agent with an explicit permission set. */
    ...
    /** v0.0.10 🍊 Joins a human to the room and returns the actor. */
