...
/** v0.0.10 🍊 REST shapes of tickets, task lists and human approval (field names exactly as in types.ts). */
@IntegrationTest
...
class TaskControllerTest {
    ...
    /** v0.0.10 🍊 A fresh room with a project manager, a researcher and Alice. */
    @BeforeEach
    void setUp() {
    ...
    /** v0.0.10 🍊 GET /api/rooms/{roomId}/tickets returns Ticket[] with exactly the contract fields. */
    @Test
    ...
    /** v0.0.10 🍊 GET /api/agents/{agentId}/tasks returns TaskListView with exactly the contract fields. */
    @Test
    ...
    /** v0.0.10 🍊 POST /api/task-lists/{listId}/approve by a human archives the list and returns the new view. */
    @Test
    ...
    /** v0.0.10 🍊 Approval errors: unfinished list, unknown user or list, missing body field, other room's human. */
    @Test
    ...
    /** v0.0.10 🍊 /api/bootstrap carries the room's tickets and one TaskListView per present agent. */
    @Test
    ...
    /** v0.0.10 🍊 The POST request of a human approval. */
    ...
    /** v0.0.10 🍊 Performs a request, checks the status and parses the JSON body. */
    ...
    /** v0.0.10 🍊 Only contract fields are present, and every required one is. */
    ...
    /** v0.0.10 🍊 An ApiError body with the expected code. */
    ...
    /** v0.0.10 🍊 Field names of a JSON object. */
